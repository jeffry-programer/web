...
class SearchCauchera extends Component
{
    use WithPagination;

    public $type_store = 'Cauchera';
    ...
    public function mount(){
        ...
        $this->categories = CategoryStore::where('type_stores_id', env('TIPO_CAUCHERA_ID'))->get();
    }
    ...
    {
        return view('livewire.search-cauchera');
    }
}
