...
<x-app-layout>
    ...
    background-image: url('{{asset('images/cauchera.jpg')}}');
    ...
    background-position: center;">
        <div class="row">
            <div class="col-md-8 mt-md-5 pb-md-5 text-white">
                ...
                <p style="font-size: 1.2rem;font-weight: 900;text-shadow: 1px 1px 1px #000, -1px 1px 1px #000, -1px -1px 0 #000, 1px -1px 0 #000">Todos los usuarios podrán comunicarse directamente y acceder a los servicios de cauchera</p>
            ...
            <div class="col-md-4">
                ...
                border-radius: 15px !important;">
                    ...
                    padding: 1rem;
                    border-radius: 15px;">
                        <h3 class="fw-bolder">Registrate como una cauchera</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register2') }}">
                            ...
                            <input type="hidden" name="profiles_id" value="6">
