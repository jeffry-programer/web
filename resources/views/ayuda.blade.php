            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="p-4" style="margin-left: 100px;">
                        <h2 class="text-justify mt-5">¿Como buscar repuestos en Tulobuscas? Ahorra tiempo y dinero </h2>            
                       ...
                       <h2 class="text-justify mt-5">¿Porque usar la plataforma Tulobuscas? </h2>            
