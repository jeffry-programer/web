<div>
    <div class="modal-header">
        ...
        <button type="button" class="btn-close" onclick="closeModal();" wire:click="cleanData()"></button>
    </div>
    <div class="modal-body">
        <div class="row">
            <div class="col-md-4 form-group">
                ...
                <select class="form-select" wire:model="country_id" id="country_id" wire:change="search">
