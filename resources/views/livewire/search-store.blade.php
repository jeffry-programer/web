    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div>
                ...
                <div class="alert alert-info mt-3" id="new_message_store2" style="display: none">
                    No hemos encontrado resultados que coincidieran con tu búsqueda, aquí puedes ver otros
                    resultados en tu mismo estado.
                </div>
                <div class="alert alert-info mt-3" id="new_message_store3" style="display: none">
                    No hemos encontrado resultados que coincidieran con tu búsqueda, aquí puedes ver otros
                    resultados en tu mismo país.
                </div>
            </div>
            <div class="row" id="showstore">
                <!-- Aquí se mostrarán las tiendas -->
            </div>
            <div class="row d-none" id="loading-more-store" style="margin-top: .5rem">
                <div class="col-12 text-center">
                    <button class="btn btn-warning" id="load-products-store">Cargar más..</button>
                </div>
            </div>
            <div class="row" id="emptystore" style="display: none">
            ...
            if (!loading && hasMoreStores){ // Verificar si hay más tiendas disponibles
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'name_store': $("#name-search-store").val(),
                        'page': page,
                        'type': 'Tienda'
                    },
                    headers: {
                    ...
                    success: function(response) {
                        showMessage(response); // Mostrar mensaje antes de cargar las tiendas
                        ...
                        if (hasMoreStores) {
                            $("#loading-more-store").removeClass('d-none');
                        } else {
                            $("#loading-more-store").addClass('d-none');
                        }
