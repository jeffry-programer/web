<div>
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-12 form-group">
                ...
                <select wire:ignore class="form-select" wire:model="municipalities_id" id="municipality"
            ...
            <div class="col-12 form-group">
                <label for="country" class="py-3">Sectores</label>
                <select class="form-select" wire:model="sectors_id" id="sector">
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="btn-save-ubi">Guardar</button>
    </div>
</div>