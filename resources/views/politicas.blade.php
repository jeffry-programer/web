        ...
        <div class="row justify-content-center">
          <div class="col-md-12">
            <div class="p-4" style="margin-left: 100px;">
                ...
                <h2 class="text-justify mt-5">En Tucomparas, nos esforzamos por proporcionar transparencia a nuestros usuarios sobre la información que recopilamos cuando utilizan nuestra plataforma</h2>
                ...
                <h2 class="text-justify mt-5">¿Los usuarios de Tulobuscas comparten su información?</h2>
